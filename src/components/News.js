...
function News(props){
    ...
    const updateNews = async () => {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=${props.country}&apiKey=81eb3d155da54414bfd279686f10a525&pagesize=${props.pagesize}&category=${props.category}&page=${page}`;
